...
| **Hậu điều kiện** | Document mới được upload và thêm vào danh sách |
...
| **Actor** | User |
| **Tiền điều kiện** | User đã đăng nhập thành công và đang ở giao diện Session chi tiết |
| **Hậu điều kiện** | Danh sách Document được hiển thị |
...
| **Use Case** | Xem thông tin Document |
| **Actor** | User |
| **Tiền điều kiện** | User đã đăng nhập thành công và đang ở giao diện Session chi tiết với ít nhất một Document |
...
| **Use Case** | Cập nhật Document |
| **Actor** | User |
| **Tiền điều kiện** | User đã đăng nhập thành công và đang ở giao diện Session chi tiết với quyền chỉnh sửa |
...
| **Actor** | User |
| **Tiền điều kiện** | User đã đăng nhập thành công và đang ở giao diện Session chi tiết với quyền chỉnh sửa |
| **Hậu điều kiện** | Document được xóa khỏi hệ thống và danh sách được cập nhật |
