...
sequenceDiagram
    ...
    User->>SessionCreateDialog: Nhập thông tin và click nút "Tạo"
...
sequenceDiagram
    ...
    User->>SessionUpdateDialog: Nhập thông tin và click nút "Lưu"
...
sequenceDiagram
    ...
    User->>SessionDeleteDialog: Click nút "Xóa"
